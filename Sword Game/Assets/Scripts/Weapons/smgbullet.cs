...
public class smgbullet : MonoBehaviour
{
    ...
    {
        if (other.gameObject.CompareTag("Enemy") || other.gameObject.CompareTag("Ground") || other.gameObject.CompareTag("RedPlayer") || other.gameObject.CompareTag("BluePlayer") || other.gameObject.CompareTag("Shield"))
        {
            Destroy(this.gameObject);
            Debug.Log("suidh");
        }
